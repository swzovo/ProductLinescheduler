...
plutil -replace CFBundleShortVersionString -string "3.5.9" "$APP_PATH/Contents/Info.plist"
plutil -replace CFBundleVersion -string "3.5.9" "$APP_PATH/Contents/Info.plist"
