...
plutil -replace CFBundleShortVersionString -string "3.5.7" "$APP_PATH/Contents/Info.plist"
plutil -replace CFBundleVersion -string "3.5.7" "$APP_PATH/Contents/Info.plist"
